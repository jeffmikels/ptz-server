...
class Command {
    ...
    _mergeDefaults(opts = {}) {
        ...
        for (let key in Object.keys(defaults)) {
            defaults[key] = (_a = opts[key]) !== null && _a !== void 0 ? _a : defaults[key];
        }
        return defaults;
    }
    _parsePacket(packet) {
...
// Information Display
// ---------------- Inquiries ---------------------------
Command.inqCameraPower = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_POWER, onComplete, IsOnParser);
Command.inqCameraICRMode = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_ICR, onComplete, IsOnParser);
Command.inqCameraICRAutoMode = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_AUTO_ICR, onComplete, IsOnParser);
Command.inqCameraICRThreshold = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_AUTO_ICR_THRESHOLD, onComplete, v2iParser);
Command.inqCameraGainLimit = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_GAIN_LIMIT, onComplete);
Command.inqCameraGain = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_GAIN_DIRECT, onComplete, v2iParser);
Command.inqCameraGainR = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_RGAIN_DIRECT, onComplete, v2iParser);
Command.inqCameraGainB = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_BGAIN_DIRECT, onComplete, v2iParser);
Command.inqCameraDZoomMode = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_DZOOM, onComplete, IsOnParser);
Command.inqCameraZoomPos = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_ZOOM_DIRECT, onComplete, v2iParser);
Command.inqCameraFocusAutoStatus = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_FOCUS_AUTO, onComplete, IsOnParser);
Command.inqCameraFocusAutoMode = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_FOCUS_AF_MODE, onComplete);
Command.inqCameraFocusIRCorrection = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_FOCUS_IR_CORRECTION, onComplete);
Command.inqCameraFocusPos = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_FOCUS_DIRECT, onComplete, v2iParser);
Command.inqCameraFocusNearLimit = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_FOCUS_NEAR_LIMIT_POS, onComplete, v2iParser);
Command.inqCameraFocusAutoIntervalTime = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_FOCUS_AF_INTERVAL, onComplete, AFIntervalParser);
Command.inqCameraFocusSensitivity = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_FOCUS_SENSE_HIGH, onComplete);
Command.inqCameraWBMode = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_WB_MODE, onComplete);
Command.inqCameraExposureMode = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_EXPOSURE_MODE, onComplete);
Command.inqCameraShutterSlowMode = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_SHUTTER_SLOW_AUTO, onComplete, IsOnParser);
Command.inqCameraShutterPos = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_SHUTTER_DIRECT, onComplete, v2iParser);
Command.inqCameraIris = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_IRIS_DIRECT, onComplete, v2iParser);
Command.inqCameraBrightness = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_BRIGHT_DIRECT, onComplete, v2iParser);
Command.inqCameraExposureCompensationStatus = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_EXP_COMP_ENABLE, onComplete, IsOnParser);
Command.inqCameraExposureCompensation = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_EXP_COMP_DIRECT, onComplete, v2iParser);
Command.inqCameraBacklightStatus = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_BACKLIGHT, onComplete, IsOnParser);
Command.inqCameraWideDStatus = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_WIDE_D, onComplete);
Command.inqCameraWideD = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_WIDE_D_SET, onComplete);
Command.inqCameraAperture = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_APERTURE_DIRECT, onComplete, v2iParser);
Command.inqCameraHighResStatus = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_HIRES_ENABLE, onComplete, IsOnParser);
Command.inqCameraNoiseReductionStatus = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_NOISE_REDUCTION, onComplete);
Command.inqCameraHighSensitivityStatus = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_HIGH_SENSITIVITY, onComplete, IsOnParser);
Command.inqCameraFreezeStatus = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_FREEZE, onComplete, IsOnParser);
Command.inqCameraEffect = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_EFFECT, onComplete);
Command.inqCameraEffectDigital = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_EFFECT_DIGITAL, onComplete);
Command.inqCameraEffectDigitalLevel = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_EFFECT_LEVEL, onComplete);
Command.inqCameraID = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_ID_WRITE, onComplete, v2iParser);
Command.inqCameraChromaSuppressStatus = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_CHROMA_SUPPRESS, onComplete);
Command.inqCameraColorGain = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_COLOR_GAIN, onComplete, v2iParser);
Command.inqCameraColorHue = (recipient = -1, onComplete) => Command.inqCamera(recipient, C.CAM_COLOR_HUE, onComplete, v2iParser);
// these use op commands
Command.inqVideoSystemNow = (recipient = -1, onComplete) => Command.inqOp(recipient, C.OP_VIDEO_FORMAT_I_NOW, onComplete, VideoSystemParser);
Command.inqVideoSystemNext = (recipient = -1, onComplete) => Command.inqOp(recipient, C.OP_VIDEO_FORMAT_I_NEXT, onComplete, VideoSystemParser);
Command.inqCameraPanSpeed = (recipient = -1, onComplete) => Command.inqOp(recipient, C.OP_PAN_MAX_SPEED, onComplete, PTMaxSpeedParser);
Command.inqCameraPanPos = (recipient = -1, onComplete) => Command.inqOp(recipient, C.OP_PAN_POS, onComplete, PTPosParser);
Command.inqCameraPanStatus = (recipient = -1, onComplete) => Command.inqOp(recipient, C.OP_PAN_STATUS, onComplete, PTStatusParser);
// block inquiry commands
Command.inqCameraLens = (recipient = -1, onComplete) => { let c = Command.raw(recipient, C.CAM_LENS_INQUIRY); c.dataParser = CamLensDataParser; c.onComplete = onComplete; return c; };
Command.inqCameraImage = (recipient = -1, onComplete) => { let c = Command.raw(recipient, C.CAM_IMAGE_INQUIRY); c.dataParser = CamImageDataParser; c.onComplete = onComplete; return c; };
// Parsers
class NoParser {
}
...
v2iParser.parse = (data) => v2i(data);
class v2siParser {
}
v2siParser.parse = (data) => v2si(data);
class IsOnParser {
}
IsOnParser.parse = (data) => data == C.DATA_ONVAL;
...
PTPosParser.parse = (data) => Object.freeze({ panPos: v2si(data.slice(0, 4)), tiltPos: v2si(data.slice(4, 8)) });
class PTStatusParser {
}
PTStatusParser.parse = (data) => new PTStatus(data);
class PTStatus {
    constructor(data) {
...
CamLensDataParser.parse = (data) => new CamLensData(data);
class CamLensData {
    constructor(data) {
...
CamImageDataParser.parse = (data) => new CamImageData(data);
class CamImageData {
    constructor(data) {
